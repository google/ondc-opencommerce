...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:erVUN5ISH4UP2r4nZZ0G5RDujJmfEJUC68xH4zw+Bqs=",
        version = "v0.0.0-20230706163441-5700902cbcbb",
    )
    ...
    go_repository(
        ...
        build_extra_args = ["-exclude=src"],  # keep - see https://github.com/census-instrumentation/opencensus-proto/issues/200
    ...
    go_repository(
        name = "com_github_zenazn_pkcs7pad",
        importpath = "github.com/zenazn/pkcs7pad",
        sum = "h1:m1h+vudopHsI67FPT9MOncyndWhTcdUoBtI1R1uajGY=",
        version = "v0.0.0-20170308005700-253a5b1f0e03",
    )
